...
#             parse_email = parseOutText(email)
            
#             ### use str.replace() to remove any instances of the words
#             ### ["sara", "shackleton", "chris", "germani"]
#             replaced_string = {"sara":"", "shackleton":"", "chris":"", "germani":""}
#             for x,y in replaced_string.items():
#                 parse_email = parse_email.replace(x,y)
            
#             ### append the text to word_data
#             word_data.append(parse_email)
