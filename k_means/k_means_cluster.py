...
# ### get stock option range
# import numpy as np
# exercised_stock_options_list = []
# for name in data_dict.keys():
#     if data_dict[name]['exercised_stock_options'] != "NaN":
#         exercised_stock_options_list.append(data_dict[name]['exercised_stock_options'])

# print np.array(exercised_stock_options_list).min(), np.array(exercised_stock_options_list).max()
...
# ### get salary option range
import numpy as np
salary_list = []
for name in data_dict.keys():
    if data_dict[name]['salary'] != "NaN":
        salary_list.append(data_dict[name]['salary'])

print np.array(salary_list).min(), np.array(salary_list).max()
